...
// ── Per-state land bounding boxes + centroids ──
// Format: [lonMin, latMin, lonMax, latMax, centLon, centLat]
// Points outside the box are ocean/abroad and snap to the state centroid.
// Boxes are large enough to include all major cities in each state.
const STATE_LAND = {
  ME:[-71.1,43.0,-66.9,47.5,-69.4,45.4], VT:[-73.4,42.7,-71.5,45.0,-72.6,44.0],
  NH:[-72.6,42.7,-70.7,45.3,-71.6,43.7], MA:[-73.5,41.2,-69.8,42.9,-71.8,42.4],
  RI:[-71.9,41.1,-71.1,42.0,-71.5,41.7], CT:[-73.7,41.0,-71.8,42.1,-72.7,41.6],
  NY:[-79.8,40.5,-71.8,45.0,-75.0,43.0], NJ:[-75.6,38.9,-73.9,41.4,-74.5,40.0],
  PA:[-80.5,39.7,-74.7,42.3,-77.2,40.9], DE:[-75.8,38.4,-74.9,39.8,-75.5,39.0],
  MD:[-79.5,37.9,-75.0,39.7,-76.6,39.1], DC:[-77.1,38.8,-76.9,38.9,-77.0,38.9],
  VA:[-83.7,36.5,-75.2,39.5,-79.5,37.5], WV:[-82.6,37.2,-77.7,40.6,-80.5,38.9],
  NC:[-84.3,33.7,-75.5,36.6,-79.0,35.5], SC:[-83.4,32.0,-78.5,35.2,-81.0,33.8],
  GA:[-85.6,30.4,-80.8,35.0,-83.4,32.7], FL:[-87.6,24.4,-80.0,31.0,-81.5,28.5],
  AL:[-88.5,30.1,-84.9,35.0,-86.8,32.8], MS:[-91.7,30.1,-88.1,35.0,-89.5,32.5],
  TN:[-90.3,34.9,-81.7,36.7,-86.0,35.8], KY:[-89.6,36.5,-81.9,39.2,-84.3,37.5],
  OH:[-84.8,38.4,-80.5,42.0,-82.8,40.4], IN:[-88.1,37.8,-84.8,41.8,-86.3,40.0],
  IL:[-91.5,36.9,-87.5,42.5,-89.2,40.0], MI:[-90.4,41.7,-82.4,48.3,-84.5,44.3],
  WI:[-92.9,42.5,-86.8,47.1,-89.8,44.3], MN:[-97.2,43.5,-89.5,49.4,-94.3,46.4],
  IA:[-96.6,40.4,-90.1,43.5,-93.5,42.0], MO:[-95.8,35.9,-89.1,40.6,-92.5,38.5],
  ND:[-104.1,45.9,-96.6,49.0,-100.5,47.5],SD:[-104.1,42.5,-96.5,45.9,-100.0,44.5],
  NE:[-104.1,40.0,-95.3,43.0,-99.9,41.5], KS:[-102.1,37.0,-94.6,40.0,-98.4,38.5],
  OK:[-103.0,33.6,-94.4,37.0,-97.5,35.5], TX:[-106.7,25.8,-93.5,36.5,-99.3,31.5],
  LA:[-94.0,28.9,-88.8,33.0,-92.0,31.0],  AR:[-94.6,33.0,-89.6,36.5,-92.0,34.8],
  NM:[-109.1,31.3,-103.0,37.0,-106.0,34.5],CO:[-109.1,37.0,-102.0,41.0,-105.5,39.0],
  WY:[-111.1,41.0,-104.1,45.0,-107.5,43.0],MT:[-116.1,44.4,-104.0,49.0,-109.5,47.0],
  ID:[-117.2,42.0,-111.0,49.0,-114.5,44.5],UT:[-114.1,37.0,-109.0,42.0,-111.5,39.5],
  AZ:[-114.8,31.3,-109.0,37.0,-111.5,34.3],NV:[-120.0,35.0,-114.0,42.0,-116.8,39.0],
  CA:[-124.5,32.5,-114.1,42.0,-119.5,37.0],OR:[-124.6,42.0,-116.5,46.3,-120.5,44.0],
  WA:[-124.7,45.5,-116.9,49.0,-120.5,47.5],
};

function snapToLand(lat, lon, state) {
  const b = STATE_LAND[state];
  if (!b) return { lat, lon };
  // If within state's land bounding box → on land, keep as-is
  if (lon >= b[0] && lat >= b[1] && lon <= b[2] && lat <= b[3]) {
    return { lat, lon };
  }
  // Outside the box → offshore or abroad, snap to centroid
  return { lat: b[5], lon: b[4] };
}
